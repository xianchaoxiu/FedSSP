...
def args_parser():
    ...
    parser.add_argument("--beta", type=float, default=0.01, help="Regularization term")
    parser.add_argument("--tau", type=float, default=0.01, help="Regularization term")
    parser.add_argument("--lambda1", type=float, default=0.01, help="Regularization term")
    parser.add_argument("--lambda2", type=float, default=0.01, help="Regularization term")
    parser.add_argument("--num_global_iters", type=int, default=250)
    parser.add_argument("--local_epochs", type=int, default = 30)
    parser.add_argument("--dim", type=int, default = 3)
    parser.add_argument("--p", type=lambda x: float(eval(x)), default=0.0, choices=[0.0, 0.5, 2/3])  # 支持分数
    parser.add_argument("--q", type=lambda x: float(eval(x)), default=0.0, choices=[0.0, 0.5, 2/3])  # 支持分数
    parser.add_argument("--fileName", type=str, default="")

    parser.add_argument("--optimizer", type=str, default="SGD")
    parser.add_argument("--algorithm", type=str, default="ADMM",choices=["FedPG","FedPE", "FedAE", "FedAE2", "FedBiGAN", "FedBiGAN2","FedPGSS"])
